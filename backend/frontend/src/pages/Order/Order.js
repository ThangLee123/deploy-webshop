        ...
        confirm({
          ...
          content: (
            <div className="order-rollback-information">
              ...
              />
              <TextArea
                className="order-rollback-reason"
                rows={4}
                        ...
                        >
                          ...
                          {!order.isPaid && order.paymentMethod === "VNPay" && (
                            ...
                            >
                              ...
                              >
                                <VnPayIcon />
                                <div className={cx("vnpay-button-text")}>
                                  Pay Order
                                </div>
                              </div>
                            </div>
                          ...
                          {order.isPaid ? (
                            <>
                              ...
                              {!order.isRollback ? (
                                ...
                                >
                                  Please Wait For The Admin To Handle Rollback
                                  Request Order For You
                                </div>
